...
import { createPost, deletePost, findAllPosts, findPost, findUniquePost, updatePost } from '../services/postService';

export const createPostHandler = async (req: grpc.ServerUnaryCall<CreatePostRequest__Output, PostResponse>, res: grpc.sendUnaryData<PostResponse>) => {
    try {
